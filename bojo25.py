...
options = {
    'proxy': {
        'http': 'http://1dbaa052cf65bb3db213__cr.bg:6dc234a7f64de12d@gw.dataimpulse.com:10125',
        'https': 'https://1dbaa052cf65bb3db213__cr.bg:6dc234a7f64de12d@gw.dataimpulse.com:10125',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/baa0d7e5-ef78-417d-b475-630da858ffdb")
time.sleep(50000)
