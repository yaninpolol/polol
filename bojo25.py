...
options = {
    'proxy': {
        'http': 'http://1dbaa052cf65bb3db213__cr.tr:6dc234a7f64de12d@gw.dataimpulse.com:10125',
        'https': 'https://1dbaa052cf65bb3db213__cr.tr:6dc234a7f64de12d@gw.dataimpulse.com:10125',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/fd7edba9-f0f7-465c-9872-74e362b1656c")
time.sleep(50000)
